...
image_path = os.path.join(current_path, "images")  # image folder 반환
...
# 공 크기에 따른 최초 스피드
ball_speed_y = [-18, -15, -12, -9]  # index 0,1,2,3에 해당 하는 값
...
# 천장에 닿은 무기 없애기
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        # 가로 벽에 다호았을 때 공 이동 위치 변경 (튕겨 나오는 효과)
